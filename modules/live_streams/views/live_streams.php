    ...
    <section id="live">
        <ul role="list" class="grid">
            ...
            <li class="live-stream">
                ...
                <?php endif; ?>
                <div class="content">
                    <?php foreach($stream['pictures'] as $picture): ?>
                        <img
                                class="image"
                                src="<?= $picture ?>"
                                alt=""
                    ...
                    <dl class="details">
                        ...
                        <dd>
                            <details>
                                <summary class="title"><?= nl2br($stream['summary']) ?></summary>
                                <p><?= nl2br($stream['description']) ?></p>
                            </details>
                        </dd>
                    </dl>
                </div>
                <div class="divider">
                    ...
                    <div class="action">
                        <?php if(!empty($stream['playlist'])): ?>
                            <a class="watch-stream" data-playlist="<?= $stream['playlist'] ?>">
                        ...
                        <?php else: ?>
                            <?php if ($stream['live']): ?>
                                <a class="join-session" data-id="<?= $stream['id'] ?>">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="var(--primary)">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 10l4.553-2.277A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.895L15 14" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 8v8m-8.25 4H7a2 2 0 01-2-2v-8a2 2 0 012-2h3.75M16 4h-4a2 2 0 00-2 2v.25M16 4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2.343m5-2.593V7.25" />
                                    </svg>
