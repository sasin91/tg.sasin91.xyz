...
const assetsPath = container.dataset.assetsPath;

const fileLoader = new THREE.FileLoader();
fileLoader.setPath(assetsPath);

const gltfLoader = new GLTFLoader();
gltfLoader.setPath(assetsPath);
...
function animate() {
  ...
  if (playerModel) {
    ...
    playerModel.rotateY(Math.max(-0.05, Math.min(sanitisedAngle, 0.05)));
